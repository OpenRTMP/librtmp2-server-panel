...
TEST_PATH = Path("tests/test_gunicorn_indirect_workers_bypass.py")
...
replace_function(
    "_call_is_getattr_operator_namespace_mutation",
    r'''
...
replace_function(
    "_is_operator_attrgetter_factory",
    r'''
...
replace_function(
    "_call_is_operator_attrgetter_namespace_mutation",
    r'''
...
TEST_PATH.write_text(test_text.replace(anchor, additions, 1), encoding="utf-8")
